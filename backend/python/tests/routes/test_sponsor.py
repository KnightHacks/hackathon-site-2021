...
"""This script was worked on by Conroy."""
class TestSponsorsBlueprint(BaseTestCase):
    ...
    def test_delete_sponsor(self):
        ...
        #resemble someone using the delete sponsor route to delete the one that we just created
        res = self.client.delete("/api/sponsors/delete_sponsor/Bose/")

        #ensure that the sponsor was successfully deleted
        self.assertEqual(res.status_code, 201)
